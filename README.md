...
| `gemini_delete_chat` | Удалить Gemini чат по URL или `chat_id` и очистить связанные локальные сессии |
...
gemini_delete_chat(chat_id="https://gemini.google.com/app/c_abc123")
...
| `gemini_delete_chat` | Delete a Gemini chat by URL or `chat_id` and clear linked local sessions |
